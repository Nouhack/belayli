    ...
    >
      <HStack w="100%" h="40%" spacing={5}>
        <Flex
          ...
          borderRadius={20}
        >
          <VStack h="100%" align="start" p={7} w="50%">
            <Text fontSize="xl" color="#38557c" fontWeight="bold" mt="10px">
              Hello , Slamani mehdi !
            </Text>
            <Text fontSize="sm" color="#5a7393" fontWeight="semibold" mt="10px">
              How Are you doing today , hope you are well dont forget to check
              the calendar for more events !
            </Text>
      ...
      >
        <Flex
          ...
          p={10}
        >
          <Text fontSize="xl" color="#38557c" pt="20px" fontWeight="bold">
            Visualize your appeal
          </Text>
          <Text fontSize="lg" color="#5a7393" pt="20px" fontWeight="semibold">
            Now you can visualize all the appeals that you made , whether the
            appeal is approved or denied
          </Text>

          <Button bg="#1479ff" mt={10} pr="30px" pl="30px" color="white">
            Verify appeal
          </Button>
        </Flex>
        <Box w="50%" h="100%">
